//Mi Ecommerce🔥 ACEPTAR CONDICIONES DOLARES🔥 SWEETALERT2--------------------------------------------------------------

Swal.fire({
  title: 'RESTRICCIONES DOLAR Y CRYPTOMONEDAS',
  text: "Debido a restriccoines gubernamentales por favor acepte las cotizaciones de dolar blue y cryptos antes de comprar su pet",
  icon: 'warning',
  showCancelButton: true,
  confirmButtonColor: '#3085d6',
  cancelButtonColor: '#d33',
  confirmButtonText: 'Acepto las condiciones del dolar blue'
}).then((result) => {
  if (result.isConfirmed) {
    Swal.fire(
      'Gracias por aceptar los terminos y condiciones de compra',
      'Continuar con la compra de Pets del Metaverso 💗',
      'success'
    )
  }
})
...
//Mi Ecommerce🔥 ATENCION RESTRICCIONES AL DOLAR PARA COMPRAR PETS🔥 FLETCH--------------------------------------------------------------
